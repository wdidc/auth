...
$studentsJSON = "/var/www/api.wdidc.org/students/students.json";
...
$studs = json_decode(file_get_contents($studentsJSON), true);
...
file_put_contents($studentsJSON, json_encode($studs));
